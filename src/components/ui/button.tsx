...
const buttonVariants = cva(
  "nexus-micro-lift inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium outline-none focus-visible:ring-2 focus-visible:ring-ring/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:translate-y-0 disabled:opacity-55 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 hover:ring-2 hover:ring-primary/20",
        outline:
          "bg-transparent text-foreground ring-1 ring-border hover:bg-surface-raised hover:text-foreground",
        secondary:
        ...
        destructive:
          "bg-destructive/10 text-destructive ring-1 ring-destructive/40 hover:bg-destructive/15 hover:text-destructive focus-visible:ring-destructive/40",
